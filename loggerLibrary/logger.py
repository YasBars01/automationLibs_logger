...
class Logger:
    """
        ...
        :params str show_logger_id: If set to Yes, the log_id will be visible in the logs. Useful when using multiple logs
        :params str enable_stdout: Use stdout instead of logging to output logs. Enable when deploying to cloud to see logs
